 ...
 * @author Brian
 */
public class admini_mode extends javax.swing.JFrame {

    /**
     * Creates new form admini_mode
     */
    public admini_mode() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton5.setText("INICIAR/FINALIZAR VOTACION");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admini_mode().setVisible(true);
            }
        });
    }
