...
public class sel_votacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Presidente");

        jButton2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jButton2.setText("Senador");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sel_votacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sel_votacion().setVisible(true);
            }
        });
    }
